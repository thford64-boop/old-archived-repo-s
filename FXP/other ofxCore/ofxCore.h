...
// NOTE: OfxHost is defined as a struct below — the typedef void* placeholder
// is intentionally removed so the struct definition takes effect.
// typedef void* OfxHost;  ← removed
...
#define kOfxPluginDescription           kOfxPropPluginDescription   // alias used in effect .cpp files
